...
public class TitleScene : Scene
{
  ...
  // <summary>
  // The font used to render the title text at a smaller size for the press enter text.
  // </summary>
  ...
  // <summary>
  // The origin to set for the dungeon text when drawing it.
  // </summary>
  ...
  // <summary>
  // The origin to set for the slime text when drawing it.
  // </summary>
